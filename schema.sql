...
CREATE TABLE gene_pool (
    ...
    slot_name       TEXT NOT NULL,           -- e.g. 'headline', 'subhead', 'cta_text', 'media_asset', 'audience'
    slot_value      TEXT NOT NULL,           -- the actual content or identifier
    description     TEXT,                    -- human-readable note for reports
    is_active       BOOLEAN NOT NULL DEFAULT TRUE,
    metadata        JSONB,                  -- structured data (e.g. meta_audience_id)
    source          TEXT,                   -- provenance: seed, user, llm_suggested, llm_approved
...
COMMENT ON COLUMN variants.genome IS
    ...
    '{"headline": "Limited time offer", "subhead": "Join 12k+ customers", "cta_text": "Learn more", "media_asset": "video.mov", "audience": "retargeting_30d"}';

COMMENT ON COLUMN variants.hypothesis IS
    'What this variant is testing, generated by the variation generator agent. '
    'e.g. "Testing new headline with proven video on retargeting audience"';
...
COMMENT ON TABLE element_performance IS
    ...
    'like "how does this headline perform across all variants?"';
